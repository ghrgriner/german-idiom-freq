...
def count_regexes(df, output_file, chunksize, verb_forms=None,
    ...
    n_cores : int (>0) or None [default]
        ...
        passed. Note that if `match_file` (see below) is not `None` then an
        additional process will be started to write the matches that is not
        counted in the value of this parameter.
